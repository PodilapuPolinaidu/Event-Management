          ...
          <div className="container mx-auto px-4 md:px-12">
            ...
            <div className="flex w-full">
              <button
                ...
                className={`px-8 py-3.5 font-semibold text-sm uppercase transition-colors rounded-tl-lg ${activeTab === "search"
              ...
              <button
                ...
                className={`px-8 py-3.5 font-semibold text-sm uppercase transition-colors rounded-tr-lg ${activeTab === "advance"
                    ? "bg-primary text-primary-foreground"
                    : "bg-primary/75 text-primary-foreground/80 hover:bg-primary/85"
                  }`}
              >
